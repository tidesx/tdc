...
static const uint256 hashGenesisBlock("0x0000049ab0158169c4348b20d8b37afd860684e9fdedc8d3bd8e28ef7138714e");
static const uint256 hashGenesisBlockTestNet("0x");
inline int64_t PastDrift(int64_t nTime)   { return nTime - 900 * 60; } // up to 90 minutes from the past
inline int64_t FutureDrift(int64_t nTime) { return nTime + 900 * 60; } // up to 90 minutes from the future
