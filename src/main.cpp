...
unsigned int nModifierInterval = 100 * 60;
...
const string strMessageMagic = "TIDE Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
	...
	{ 
		nSubsidy = 300000000 * COIN; return nSubsidy; 
	}
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "TIDE", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "TIDE 2017 borned";
        CTransaction txNew;
        txNew.nTime = 1493300000;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime = 1493300000;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce = 1186701;
		if(fTestNet)
        {
            block.nNonce = 0 ;
        }
		
		uint256 nhashMerkleRoot = uint256("0x06315fdbdfbd4d25ba3922f9957b39d64042527f963bfc0c38888abfb017c57e");
...
unsigned char pchMessageStart[4] = { 0xec, 0xc1, 0x12, 0xae };
